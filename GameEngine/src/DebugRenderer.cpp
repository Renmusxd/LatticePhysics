...
void DebugRenderer::end(){
    ...
    glBufferData(GL_ARRAY_BUFFER,m_verts.size()*sizeof(DebugVertex),NULL,GL_DYNAMIC_DRAW);
    // upload
    ...
    // Orphan buffer for speed
    glBufferData(GL_ARRAY_BUFFER,m_indices.size()*sizeof(GLuint),NULL,GL_DYNAMIC_DRAW);
    // upload
    glBufferSubData(GL_ARRAY_BUFFER,0, m_indices.size()*sizeof(GLuint),m_indices.data());
    glBindBuffer(GL_ARRAY_BUFFER,0);
                            ...
                            float angle)
{
    ...
    m_indices.push_back(i);m_indices.push_back(i+1);
    m_indices.push_back(i+1);m_indices.push_back(i+2);
    m_indices.push_back(i+2);m_indices.push_back(i+3);
    m_indices.push_back(i+3);m_indices.push_back(i);
}
...
void DebugRenderer::drawCircle(const glm::vec2& center, const ColorRGBA8& color, float radius){
    ...
    for (int i = 0; i<NUM_VERTS; i++){
        float angle = ((float)i/NUM_VERTS) * 2.0f * glm::pi<float>();
